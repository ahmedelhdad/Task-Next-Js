    ...
    <div className="pt-16">
      <div className="container grid grid-cols-1 lg:grid-cols-7 gap-y-8 ">
        ...
        <div className="col-span-3 space-y-2 ">
          ...
          <h1 className="text-3xl font-bold text-blue-600">$2,500</h1>
          ...
          <div className="flex item-center flex-col gap-3 border-b pb-8">
              ...
              <button className="bg-blue-600 text-md border mt-3 border-blue-600 hover:text-black hover:bg-transparent transition-all text-white py-3 rounded-md">Add to cart</button>
          </div>
